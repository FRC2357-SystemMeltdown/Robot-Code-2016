...
std::shared_ptr<Relay> RobotMap::launchControllertrigger;
...
void RobotMap::init() {
    ...
    launchControllertrigger.reset(new Relay(0));
    lw->AddActuator("LaunchController", "trigger", launchControllertrigger);
