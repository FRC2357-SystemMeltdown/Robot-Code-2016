...
std::shared_ptr<SpeedController> RobotMap::launchControllerElevator;
std::shared_ptr<AnalogPotentiometer> RobotMap::launchControllerAnglePot;
...
void RobotMap::init() {
    ...
    launchControllerElevator.reset(new TalonSRX(3));
    lw->AddActuator("LaunchController", "Elevator", std::static_pointer_cast<TalonSRX>(launchControllerElevator));
    
    launchControllerAnglePot.reset(new AnalogPotentiometer(0, 1.0, 0.0));
    lw->AddSensor("LaunchController", "AnglePot", launchControllerAnglePot);
