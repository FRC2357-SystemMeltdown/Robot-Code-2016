...
LaunchController::LaunchController() : Subsystem("LaunchController") {
    ...
    elevator = RobotMap::launchControllerElevator;
    anglePot = RobotMap::launchControllerAnglePot;
    trigger = RobotMap::launchControllertrigger;
    lowLimit = RobotMap::launchControllerlowLimit;
    wheelsR = RobotMap::launchControllerWheelsR;
    wheelsL = RobotMap::launchControllerWheelsL;
